...
| 模块 | 行号范围 | 职责 |
|------|----------|------|
| **STYLES** | 20–1782 | 全局 CSS：浮动窗、弹窗、干预视觉效果、暗色模式 |
| **USER_CONFIG** | 1787–1959 | 用户可编辑的默认配置常量 |
| **ConfigManager** | 1964–2371 | 配置加载/保存/查询，白名单管理，学习时段判断 |
| **GlobalStateManager** | 2378–2572 | 全局干预状态持久化（v1.2.3） |
| **TabManager** | 2579–3649 | 多窗口 Master 选举、心跳、BroadcastChannel 同步、引导弹窗 |
| **DebugTelemetry** | 3656–3904 | 可观测性系统：事件日志、状态快照、导出分析 |
| **HistoryVideoTracker** | 3911–3993 | 离开视频 BV 号历史记录 |
| **StorageManager** | 3995–4062 | localStorage 读写封装，带内存回退机制 |
| **DEFAULT_DATA_STRUCTURES** | 4069–4126 | 三个数据模块的默认结构定义和初始化 |
| **PageMonitor** | 4131–4244 | URL/BV号监控、SPA路由变更检测、页面可见性/全屏状态 |
| **FloatingWindow** | 4249–4525 | 悬浮窗创建、拖拽、状态显示 |
| **DetailPanel** | 4530–6054 | 详细统计面板（5个模块），主题切换，白名单管理 |
| **WordVerifier** | 6059–6250 | 单词选择、答案校验、掌握度追踪 |
| **StatisticsTracker** | 6255–6391 | 学习/分心时间统计，每日归档 |
| **ModalManager** | 6397–6533 | 弹窗层级管理、z-index 统一（v1.2.5） |
| **InterventionController** | 6538–7972 | 核心状态机、视觉干预、弹窗控制、P0自动导航 |
| **Main IIFE** | 7977–8096 | 初始化入口、主定时器循环、SPA导航处理 |
