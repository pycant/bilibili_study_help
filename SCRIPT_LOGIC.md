...
| 模块 | 行号范围 | 职责 |
|------|----------|------|
| **STYLES** | 17–1784 | 全局 CSS：浮动窗、弹窗、干预视觉效果、暗色模式 |
| **USER_CONFIG** | 1786–1839 | 用户可编辑的默认配置常量 |
| **ConfigManager** | 1844–2053 | 配置加载/保存/查询，白名单管理，学习时段判断 |
| **StorageManager** | 2058–2125 | localStorage 读写封装，带内存回退机制 |
| **DEFAULT_DATA_STRUCTURES** | 2132–2188 | 三个数据模块的默认结构定义和初始化 |
| **PageMonitor** | 2193–2298 | URL/BV号监控、SPA路由变更检测、页面可见性/全屏状态 |
| **FloatingWindow** | 2303–2556 | 悬浮窗创建、拖拽、状态显示 |
| **TabManager** | 2712–3560 | 多窗口 Master 选举、心跳、注册表、引导弹窗 |
| **DebugTelemetry** | 3565–3830 | 可观测性系统：事件日志、状态快照、导出分析 |
| **HistoryVideoTracker** | 3835–3915 | 离开视频 BV 号历史记录 |
| **DetailPanel** | 3977–5260 | 详细统计面板（5个模块），主题切换，白名单管理 |
| **WordVerifier** | 5265–5401 | 单词选择、答案校验、掌握度追踪 |
| **StatisticsTracker** | 5406–5542 | 学习/分心时间统计，每日归档 |
| **InterventionController** | 5547–6322 | 核心状态机、视觉干预、弹窗控制 |
| **Main IIFE** | 6327–6474 | 初始化入口、主定时器循环、SPA导航处理 |
